            ...
            >
                <div className="bg-white py-12 px-8 shadow-[0_48px_96px_-32px_rgba(212,175,55,0.15)] border border-[#D4AF37]/10 sm:rounded-[2.5rem] sm:px-12 ring-1 ring-black/5">
                    <form className="space-y-8">
                        ...
                        <button
                            type="submit"
                            className="group w-full flex justify-between items-center py-5 px-8 rounded-2xl text-sm font-bold text-white bg-gray-900 hover:bg-[#D4AF37] transition-all duration-500 uppercase tracking-widest"
                        >
                            Enter Portal
